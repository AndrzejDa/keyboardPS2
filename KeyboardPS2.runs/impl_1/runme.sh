...
HD_PWD='D:/XilinxProjekty/KeyboardPS2/KeyboardPS2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log odczyt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source odczyt.tcl -notrace
