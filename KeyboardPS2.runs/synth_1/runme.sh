...
HD_PWD='D:/XilinxProjekty/KeyboardPS2/KeyboardPS2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log odczyt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source odczyt.tcl
